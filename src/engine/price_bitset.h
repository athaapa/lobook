...
namespace Fast {
    ...
    public:
        ...
        PriceBitset() {
            ...
            // A: std::memset is typically implemented with vectorized SIMD instructions and is
            // highly
        ...
        void set(uint32_t price_idx) {
            ...
            // guaranteed to be within 0 and 63. If price_idx % 64 > 31 bits it coud lead to
            // overflow.
        ...
        void clear(uint32_t price_idx) {
            ...
            // A: A parent bit being 1 means "at least one child bit is still set. If you always
            // cleared the parent whenever any child bit was cleared,
        ...
        std::optional<uint32_t> find_lowest() const {
            ...
            //    of an integer. It doesn't need any subtraction because trailing zeros implicitly
            //    gives you the index. The count of trailing zeros is the bit position of the lowest
            //    set bit by definition (bit 0 = 0 trailing zeros, bit 1 = 1 trailing zero, etc.).
